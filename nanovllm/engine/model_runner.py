...
class ModelRunner:
    ...
    def run(self, seqs: list[Sequence], is_prefill: bool) -> list[int]:
        # with torch.cuda.nvtx.range_push("Model_Forward"):
        #     with torch.cuda.nvtx.range_push("Prefill_Phase" if is_prefill else "Decode_Phase"):
                    # logits = self.run_model(input_ids, positions, is_prefill)
        #     torch.cuda.nvtx.range_pop() # pop prefill/decode
        # torch.cuda.nvtx.range_pop() # pop model_forward
